...
public class FightActivity extends Activity implements RoomRequestListener, NotifyListener, Animator {
    ...
    private void updateItemNotifications() {
    	...
    	attackItemsText.setText(this.currentUser.getAttackItemCount()+"");
		miscItemsText.setText(this.currentUser.getMiscItemCount()+"");
		defenceItemsText.setText(this.currentUser.getDefenseItemCount()+"");
		
		int attItemDur = this.currentUser.getAttackItemDuration();
		int defItemDur = this.currentUser.getDefenseItemDuration();
		int miscItemDur = this.currentUser.getMiscItemDuration();
