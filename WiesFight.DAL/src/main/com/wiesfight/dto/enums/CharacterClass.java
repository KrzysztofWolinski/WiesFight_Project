...
public enum CharacterClass {
	INFORMATYK(10, 50, 0.1, 0.9, 0.25, 1.5, 0, 1, 2),
	KLOSZARD(12, 70, 0.1, 0.9, 0.05, 1.5, 3, 4, 5),
	KIBIC(20, 60, 0.2, 0.5, 0.15, 1.7, 6, 7, 8),
	MOHER(10, 40, 0.1, 0.9, 0.15, 1.5, 9, 10, 11),
	BLACHARA(9, 60, 0.1, 0.9, 0.15, 1.6, 12, 13, 14),
	TRENING(7, 100, 0.1, 0.9, 0.15, 1.5, -1, -1, -1);
